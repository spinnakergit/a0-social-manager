#!/bin/bash
# Install the Social Media Manager plugin into an Agent Zero instance.
#
# Usage:
...
PLUGIN_DIR="$A0_ROOT/usr/plugins/social_manager"

echo "=== Social Media Manager Plugin Installer ==="
...
echo ""
echo "Next steps:"
echo "  1. Configure credentials in the Social Media Manager plugin settings (WebUI)"
